...
namespace marmuz_site_v1.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            List<BanEmails> banEmails = await db.BanEmails.ToListAsync();
        ...
        {
            ApplicationRole roleUser = await RoleManager.FindByNameAsync("user");
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, CompanyName=model.CompanyName, ClientName=model.ClientName};
        ...
        public async Task<ActionResult> AdminSelfDelete()
        {
            ...
            ApplicationUser user = await db.Users.Include(c => c.Comments).FirstOrDefaultAsync(c => c.UserName == User.Identity.Name);
